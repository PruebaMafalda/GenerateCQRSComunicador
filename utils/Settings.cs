namespace GenerateCQRSComunicador.Utils;
public class PathProject{
    ...
    public static string NameSpaceProject = "Core.Comunicador.Be";
    public static string ApplicationContext = "IComunicadorContext";
    public static string TestProjectContext = "TestComunicadorContext";
    public static string BaseUrl = "UrlComunicador"; // ? Reemplazar por url Comunicador
    public static string FieldLogicDeleted = "Borrado";    
}